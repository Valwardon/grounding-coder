...
pub fn initialize_capability_registry() -> HashMap<String, ProjectCapability> {
    ...
    // Core capabilities
    registry.insert("network".to_string(), ProjectCapability {
    ...
    registry.insert("filesystem".to_string(), ProjectCapability {
    ...
    registry.insert("background_execution".to_string(), ProjectCapability {
    ...
    registry.insert("notifications".to_string(), ProjectCapability {
    ...
    registry.insert("location".to_string(), ProjectCapability {
    ...
    registry.insert("camera".to_string(), ProjectCapability {
    ...
    registry.insert("solana".to_string(), ProjectCapability {
    ...
    registry.insert("websocket".to_string(), ProjectCapability {
...
pub fn validate_project_capability(capability: &str, registry: &HashMap<String, ProjectCapability>) -> bool {
